...
typedef CvStatus(CV_STDCALL *CvResizeBilinearFunc)(const void *src, int srcstep, CvSize ssize,
...
int main(int argc, char *argv[])
{
	if (argc < 8)
	{
		printf("command: path of input file, "
			   "\npath of model, "
			   "\npath of output file, "
			   "\nchannel of input, "
			   "\nheight of input, "
